...
const {Ticker,Customer} = require("../model/users.js");
...
const toptendata = async (req, res) => {
  try {
    ...
    // Store the top 10 results in MongoDB
    await Ticker.deleteMany({}); // Clear previous entries
...
module.exports = { toptendata, gettickets, createCustomer, login,getAllUsersData,getOneUsersData,updateUserData,deleteUserData, searchAUserForDelete};
